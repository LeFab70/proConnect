...
public class ActiviteCommunautaire
{
    ...
    public Adresse Lieu { get; set; } // Lieu où se déroule l'activité communautaire (Adresse est une classe qui contient les détails de l'adresse, comme le numéro, la rue, la ville, etc.)
